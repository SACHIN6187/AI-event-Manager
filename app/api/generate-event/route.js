...
export async function POST(req) {
  try {
    ...
    const systemPrompt =
        `You are an event planning assistant. Generate event details based on the user's description.
    ...
    return NextResponse.json(
        {error: 'Failed to generate event' + error.message}, {status: 500});
  }
}
